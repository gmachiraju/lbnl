...
**       This is a copy modified by Gautam Machiraju while working under Dr. Greg Hura 
**       SAXS similarity error analysis, Summer 2015
*/
...
int main(int argc, char *argv[])
{
  ...
  double MaxParticleSize = 400; //original = 400
...
//-------------------- Gautam was here -----------------
  ...
  char *x_RatFile3 = "x_RatioFile2";          
  ofstream X_RATFILE3;                             
  X_RATFILE3.open(x_RatFile3);

  char *y_RatFile3 = "y_RatioFile2";          
  ofstream Y_RATFILE3;                             
  Y_RATFILE3.open(y_RatFile3);                    
  ...
  for(i = 0; i < n; i++)
    {
      ...
      X_RATFILE3 << RatioPoint[i].qval << "\n";                         /* Gautam was here */
      Y_RATFILE3 << RatioPoint[i].Inten << "\n";                         /* Gautam was here */    
    }
...
//-------------------- Gautam was here -----------------
  ...
  char *x_RatFile4 = "x_RatioFile3";    
  ofstream X_RATFILE4;                       
  X_RATFILE4.open(x_RatFile4);       

  char *y_RatFile4 = "y_RatioFile3";    
  ofstream Y_RATFILE4;                       
  Y_RATFILE4.open(y_RatFile4);   
